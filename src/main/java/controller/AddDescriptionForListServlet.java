...
/**
 * Servlet implementation class AddDescriptionForListServlet
 */
@WebServlet("/addDescriptionForListServlet")
public class AddDescriptionForListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddDescriptionForListServlet() {
        super();
